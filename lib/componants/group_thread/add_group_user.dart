...
class AddGroupUser extends StatefulWidget {
  ...
  @override
  State<AddGroupUser> createState() => _AddGroupUserState();
}

class _AddGroupUserState extends State<AddGroupUser> {
  ...
  Widget build(BuildContext context) {
    List<User> users = Provider.of<UserProvider>(context).users
        .where((u) =>
            u.id !=
            Provider.of<ClientProvider>(context, listen: false).client.id && !widget.group.users.map<String>((e) => e.id).contains(u.id)) 
        .toList();
                ...
                ElevatedButton(
                    ...
                    onPressed: selectedUsers.isNotEmpty ? () {
                      ...
                      for (String id in selectedUsers) {
                        widget.groupService
                            .addGroupUser(userId: id, id: widget.groupId);
                      }
                    } : null,
